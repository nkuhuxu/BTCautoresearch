...
def model_fn(train_days, train_log_prices, test_days):
    ...
    a_past, b_past = _fit_trend(log10_days, train_log_prices, gamma=-2.5)
    # Fit recency-weighted trend (adapts to recent prices)
    a_rec, b_rec = _fit_trend(log10_days, train_log_prices, gamma=+0.25)
    ...
    tau_blend = 280.0  # blend half-life
